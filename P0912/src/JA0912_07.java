...
public class JA0912_07 {
	...
	public static void main(String[] args) {
		...
		Circle c2 = new Circle(new Point(150, 150), 50, "원형"); // (150,150),50,"원형"
		...
		Point[] p = { new Point(100, 100), new Point(140, 50), new Point(200, 100), }; // 3개의 점을 가지고 있는 배열

		Triangle t1 = new Triangle(p, "삼각형"); // d
		t1.draw();
